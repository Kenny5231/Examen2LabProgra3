...
Q_CONSTINIT static const qt_meta_stringdata_CLASSClientManagerENDCLASS_t qt_meta_stringdata_CLASSClientManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(66, 8),  // "isTyping"
        QT_MOC_LITERAL(75, 11),  // "nameChanged"
        QT_MOC_LITERAL(87, 4),  // "name"
        QT_MOC_LITERAL(92, 13),  // "statusChanged"
        QT_MOC_LITERAL(106, 20),  // "ChatProtocol::Status"
        QT_MOC_LITERAL(127, 6),  // "status"
        QT_MOC_LITERAL(134, 19),  // "rejectReceivingFile"
        QT_MOC_LITERAL(154, 17),  // "initReceivingFile"
        QT_MOC_LITERAL(172, 10),  // "clientName"
        QT_MOC_LITERAL(183, 8),  // "fileName"
        QT_MOC_LITERAL(192, 8),  // "fileSize"
        QT_MOC_LITERAL(201, 13),  // "connectionACK"
        QT_MOC_LITERAL(215, 6),  // "myName"
        QT_MOC_LITERAL(222, 11),  // "clientsName"
        QT_MOC_LITERAL(234, 26),  // "newClientConnectedToServer"
        QT_MOC_LITERAL(261, 9),  // "clienName"
        QT_MOC_LITERAL(271, 17),  // "clientNameChanged"
        QT_MOC_LITERAL(289, 8),  // "prevName"
        QT_MOC_LITERAL(298, 18),  // "clientDisconnected"
        QT_MOC_LITERAL(317, 9)   // "readyRead"
    },
    "ClientManager",
    "connected",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSClientManagerENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       9,    1,  101,    2, 0x06,    8 /* Public */,
      12,    0,  104,    2, 0x06,   10 /* Public */,
      13,    3,  105,    2, 0x06,   11 /* Public */,
      17,    2,  112,    2, 0x06,   15 /* Public */,
      20,    1,  117,    2, 0x06,   18 /* Public */,
      22,    2,  120,    2, 0x06,   20 /* Public */,
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::QString, QMetaType::QString,   23,   14,
...
Q_CONSTINIT const QMetaObject ClientManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSClientManagerENDCLASS_t,
        ...
        // method 'connectionACK'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QString, std::false_type>,
        QtPrivate::TypeAndForceComplete<QStringList, std::false_type>,
        // method 'newClientConnectedToServer'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QString, std::false_type>,
...
void ClientManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ClientManager::*)(QString , QStringList );
            if (_t _q_method = &ClientManager::connectionACK; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (ClientManager::*)(QString );
            if (_t _q_method = &ClientManager::newClientConnectedToServer; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 9;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &ClientManager::clientNameChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (ClientManager::*)(QString );
            if (_t _q_method = &ClientManager::clientDisconnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 11;
                return;
            }
        }
